...
|---|---|---|
| **Service Level** | Percentage of incoming calls answered within the predefined service threshold | `Calls Handled Within Threshold ÷ Calls Offered × 100` |
| **Abandonment Rate** | Percentage of customers who disconnect before reaching an agent | `Calls Abandon ÷ Calls Offered × 100` |
| **Handled Calls Ratio** | Percentage of incoming calls successfully handled by agents | `Calls Handled ÷ Calls Offered × 100` |
| **Average Speed of Answer (ASA)** | Average waiting time before an agent answers a call | `Total Answer Time ÷ Calls Handled` |
| **Efficiency** | Custom KPI evaluating overall operational effectiveness | `Service Level × Handled Calls Ratio` |
